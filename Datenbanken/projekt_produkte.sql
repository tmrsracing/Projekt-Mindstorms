...
CREATE TABLE `produkte` (
  ...
  `Produkt Name` varchar(45) DEFAULT NULL,
  `Produkt Preis` varchar(45) DEFAULT NULL,
...
INSERT INTO `produkte` VALUES (1,'eins','10'),(2,'zwei','80'),(3,'drei','50'),(4,'vier','200'),(5,'fünf','30');
